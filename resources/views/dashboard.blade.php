...
<body
    ...
    <div>
        <nav class="relative flex flex-wrap items-center justify-between px-0 py-2 mx-6 mt-4 transition-all ease-in bg-blue-500 shadow-none dark:bg-slate-850/80 dark:shadow-dark-blur dark:backdrop-blur-2xl dark:backdrop-saturate-200 duration-250 rounded-2xl lg:flex-nowrap lg:justify-start"
            ...
            <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
                <nav>
                    ...
                    <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                        ...
                        <li class="text-sm text-white pl-2 capitalize leading-normal before:float-left before:pr-2 before:text-white before:content-['/']"
                            aria-current="page">Virtual Reality</li>
                    </ol>
                ...
                <div class="flex items-center mt-2 grow sm:mt-0 sm:mr-6 md:mr-0 lg:flex lg:basis-auto">
                    <div class="flex items-center md:ml-auto md:pr-4">
                        <div class="relative flex flex-wrap items-stretch w-full transition-all rounded-lg ease">
                            <span
                                class="text-sm text-slate-500 ease leading-5.6 transition-all absolute z-50 -ml-px flex h-full items-center whitespace-nowrap rounded-lg rounded-tr-none rounded-br-none border border-r-0 border-transparent bg-transparent py-2 px-2.5 text-center font-normal">
                                <i class="fas fa-search" aria-hidden="true"></i>
                            </span>
                            <input type="text"
                                class="pl-9 text-sm dark:bg-slate-850 dark:text-white border-gray-300 focus:border-blue-500 focus:shadow-primary-outline ease w-1/100 leading-5.6 transition-all relative -ml-px block min-w-0 flex-auto rounded-lg border border-solid bg-white bg-clip-padding py-2 pr-3 text-gray-700  placeholder:text-gray-500 focus:outline-none focus:transition-shadow"
                ...
                <a class="inline-block px-8 py-2 mb-0 mr-4 font-bold text-center text-blue-500 uppercase align-middle transition-all ease-in bg-transparent border border-blue-500 border-solid rounded-lg shadow-none cursor-pointer leading-pro text-xs hover:-translate-y-px active:shadow-xs hover:border-blue-500 active:bg-blue-500 active:hover:text-blue-500 hover:text-blue-500 tracking-tight-rem hover:bg-transparent hover:opacity-75 hover:shadow-none active:text-white active:hover:bg-transparent" target="_blank" href="https://www.creative-tim.com/builder/soft-ui?ref=navbar-dashboard&amp;_ga=2.76518741.1192788655.1647724933-1242940210.1644448053">Online Builder</a>
                        ...
                        {{-- <li class="flex items-center">
                            <a href="../pages/sign-in.html"
                                class="block px-0 py-2 font-semibold text-white transition-all ease-nav-brand text-sm ">
                ...
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 focus:text-gray-500 transition duration-150 ease-in-out">
                    <svg class="h-6 w-6" stroke="currentColor" fill="none" viewBox="0 0 24 24">
                        ...
                        <li class="relative flex items-center pr-2">
                            ...
                            <ul dropdown-menu
                                class="text-sm transform-dropdown text-slate-500 before:font-awesome before:leading-default before:duration-350 before:ease lg:shadow-3xl duration-250 min-w-44 before:sm:right-8 before:right-2 pointer-events-none absolute right-0 top-0 z-50 origin-top list-none rounded-lg border-0 border-solid border-transparent bg-white bg-clip-padding px-2 py-4 text-left opacity-0 transition-all before:absolute before:left-auto before:top-0 before:z-50 before:inline-block before:text-5.5 before:font-normal before:text-white before:antialiased before:transition-all before:content-['\f0d8'] sm:-mr-6 lg:absolute lg:right-0 lg:left-auto lg:mt-2 lg:block lg:cursor-pointer">
                                <!-- add show class on dropdown open js -->
                                <li class="relative mb-2">
                                    <a class="hover:bg-gray-200 hover:text-slate-700 ease clear-both block w-full whitespace-nowrap rounded-lg bg-transparent py-1.2 px-4 duration-300 lg:transition-colors"
                                        href="javascript:;">
                                        <div class="flex py-1">
                                            <div class="my-auto">
                                ...
                                <li class="relative mb-2">
                                    <a class="hover:bg-gray-200 hover:text-slate-700 ease clear-both block w-full whitespace-nowrap rounded-lg py-1.2 px-4 transition-colors duration-300"
                                        href="javascript:;">
                                        <div class="flex py-1">
                                            <div class="my-auto">
                                                <img src="{{ asset('assets/img/small-logos/logo-spotify.svg') }}"
                                                    class="inline-flex items-center justify-center mr-4 text-white text-sm h-9 w-9 max-w-none rounded-xl bg-gradient-to-tl from-zinc-800 to-zinc-700 dark:bg-gradient-to-tl dark:from-slate-750 dark:to-gray-850" />
                                            </div>
                                            <div class="flex flex-col justify-center">
                                                <h6 class="mb-1 font-normal leading-normal text-sm"><span
            ...
            <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
                <ul class="flex flex-col pl-0 mb-0">
                    ...
                    <li class="mt-0.5 w-full">
                        <a class="py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors dark:text-white dark:opacity-80"
                            ...
                            <div
                                ...
                                <i
                                    class="relative top-0 leading-normal text-emerald-500 text-sm ni ni-credit-card"></i>
                            </div>
                    ...
                    <li class="w-full mt-4">
                        <h6 class="pl-6 ml-2 font-bold leading-tight uppercase text-xs dark:text-white opacity-60">
                            Account pages</h6>
                    </li>
                ...
                <div class="relative flex flex-col min-w-0 break-words bg-transparent border-0 shadow-none rounded-2xl bg-clip-border"
                    ...
                    <div class="flex-auto w-full p-4 pt-0 text-center">
                        <div class="transition-all duration-200 ease-nav-brand">
                            ...
                            <p class="mb-0 font-semibold leading-tight dark:text-white dark:opacity-60 text-xs">Please
                                check our docs</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="container">
                    <div class="flex flex-wrap pt-48 -mx-3">
                        <div class="max-w-full px-3 pt-12 text-center md:w-1/12 md:flex-none lg:ml-12 lg:pt-0">
                            <a href="javascript:;"
                                class="inline-flex items-center justify-center w-12 h-12 mr-6 text-white transition-all duration-200 ease-in-out border-0 text-base rounded-xl"
                                data-target="tooltip_trigger" data-placement="left">
                                <img class="w-full rounded-xl" alt="Image placeholder"
                            ...
                            <button
                                class="inline-block p-2 mb-4 mr-6 font-bold tracking-tight text-center text-black uppercase align-middle transition-all duration-200 ease-in bg-white border-0 border-white shadow-md cursor-pointer hover:-translate-y-px hover:shadow-xs active:opacity-85 leading-pro text-xs bg-150 rounded-xl bg-x-25"
                                type="button" data-target="tooltip_trigger" data-placement="left">
                        ...
                        <div class="max-w-full px-3 md:w-11/12 md:flex-none lg:w-8/12">
                            <div class="flex">
                                <div class="mr-auto">
                                    <h1
                                        class="mb-0 font-semibold text-banner-calculate leading-tighter xl:text-8xl dark:text-white">
                                        12°C</h1>
                                    <h6 class="mb-0 ml-1 uppercase dark:text-white">Cloudy</h6>
                                </div>
                                <div class="ml-auto">
                                    <img class="float-right w-1/2 lg:-mt-12"
                            ...
                            <div class="flex flex-wrap mt-6 -mx-3">
                                <div class="w-full max-w-full px-3 md:w-4/12 md:flex-none">
                                    <div
                                        class="relative flex flex-col min-w-0 overflow-hidden break-words transition-all duration-200 ease-out origin-top bg-white border-0 border-transparent shadow-xl dark:bg-slate-850 dark:shadow-dark-xl transform3d hover:transform3d-hover rounded-2xl bg-clip-border">
                                        <div class="flex-auto p-6">
                                            <div class="flex">
                                                ...
                                                <h6 class="mb-0 dark:text-white">
                                                    Synk up with Mark
                                                    <small
                                                        class="font-normal text-slate-400 dark:opacity-60 dark:text-white">Hangouts</small>
                                                </h6>
                                            </div>
                                            <hr
                                            ...
                                            <div class="flex">
                                                ...
                                                <h6 class="mb-0 dark:text-white">
                                                    Gym <br />
                                                    <small
                                                        class="font-normal text-slate-400 dark:opacity-60 dark:text-white">World
                                                        Class</small>
                                                </h6>
                                            </div>
                                            <hr
                                            ...
                                            <div class="flex">
                                                ...
                                                <h6 class="mb-0 dark:text-white">
                                                    Design Review<br />
                                                    <small
                                                        class="font-normal text-slate-400 dark:opacity-60 dark:text-white">Zoom</small>
                                                </h6>
                                            </div>
                                        </div>
                                        <a href="javascript:;"
                                            class="w-full py-1 text-center dark:bg-gray-600 bg-gray-50"
                                            data-target="tooltip_trigger" data-placement="top">
                                ...
                                <div class="w-full max-w-full px-3 mt-6 md:mt-0 md:w-4/12 md:flex-none">
                                    <div
                                        ...
                                        <div class="flex-auto p-6">
                                            <div class="flex">
                                                ...
                                                <div class="ml-auto">
                                                    ...
                                                    <p class="mb-0 leading-normal text-white dark:opacity-60 text-sm">
                                                        items</p>
                                                </div>
                                            </div>
                                        ...
                                        <a href="javascript:;" class="w-full py-1 text-center"
                                            data-target="tooltip_trigger" data-placement="top">
                                    ...
                                    <div
                                        class="relative flex flex-col min-w-0 mt-6 break-words transition-all duration-200 ease-out bg-white border-0 border-transparent shadow-xl dark:bg-slate-850 dark:shadow-dark-xl transform3d hover:transform3d-hover rounded-2xl bg-clip-border">
                                        <div class="flex-auto p-6">
                                            <div class="flex">
                                                <p class="mb-0 dark:opacity-60 dark:text-white">Emails (21)</p>
                                                <a href="javascript:;" class="ml-auto dark:text-white"
                                                    data-target="tooltip_trigger" data-placement="top"> Check </a>
                                                <div data-target="tooltip"
                                                    class="hidden px-2 py-1 text-white bg-black rounded-lg text-sm">
                                                    Check
                                                    <div class="invisible absolute h-2 w-2 bg-inherit before:visible before:absolute before:h-2 before:w-2 before:rotate-45 before:bg-inherit before:content-['']"
                                            ...
                                            <div class="relative z-20 flex-auto p-6 text-white">
                                                ...
                                                <div class="flex mt-12">
                                                    <button
                                                        ...
                                                        type="button" data-target="tooltip_trigger"
                                                        data-placement="top">
                                    ...
                                    <div
                                        ...
                                        <div class="flex-auto p-6">
                                            <div class="flex">
                                                ...
                                                <div class="ml-auto">
                                                    <a href="javascript:;"
                                                        class="relative z-20 inline-flex items-center justify-center text-white transition-all duration-200 ease-in-out border-0 rounded-full text-sm h-9 w-9 hover:z-30"
                                                        data-target="tooltip_trigger" data-placement="top">
                                                        <img class="w-full rounded-full" alt="Image placeholder"
                                                            src="{{ asset('assets/img/team-1.jpg') }}" />
                                                    </a>
                                                    <div data-target="tooltip"
                                                        class="hidden px-2 py-1 text-white bg-black rounded-lg text-sm">
                                                    ...
                                                    <a href="javascript:;"
                                                        class="relative z-20 inline-flex items-center justify-center -ml-4 text-white transition-all duration-200 ease-in-out border-0 rounded-full text-sm h-9 w-9 hover:z-30"
                                                        data-target="tooltip_trigger" data-placement="top">
                                                        <img class="w-full rounded-full" alt="Image placeholder"
                    ...
                    <ul class="flex flex-wrap justify-center pl-0 mb-0 list-none lg:justify-end">
                        <li class="nav-item">
                            <a href="https://www.creative-tim.com"
                                class="block px-4 pt-0 pb-1 font-normal transition-all ease-in-out text-slate-500 text-sm"
                                target="_blank">Creative Tim</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="https://www.creative-tim.com/license"
                                class="block px-4 pt-0 pb-1 pr-0 font-normal transition-all ease-in-out text-slate-500 text-sm"
